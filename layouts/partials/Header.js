      ...
      <nav className="navbar container px-1 sm:px-8">
        ...
        <div className="flex items-center space-x-4 xl:space-x-8">
          ...
          >
            ...
            {/* header social */}
            <Social source={socical} className="socials border-black" />
          </div>
          <ThemeSwitcher />
          {/* Header search */}
          <div
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-white lg:hidden"
          >
            {showMenu ? (
              <svg className="h-4 w-4 fill-current" viewBox="0 0 20 20">
                <title>Menu Close</title>
